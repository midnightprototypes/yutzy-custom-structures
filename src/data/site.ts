...
export const buildings: Building[] = [
  {
    ...
    alt: "Long tan and dark maroon pole barn with a single overhead door and a roof weathervane",
  ...
  },
  {
    ...
    alt: "Four-bay post-frame garage with a dark brown roof and a covered side entry",
  ...
  },
  {
    ...
    alt: "Gray hobby shop with two white overhead doors and a Yutzy nameplate on the peak",
  ...
  },
  {
    ...
    alt: "Two-story gray gambrel-roof equestrian barn with dormer windows and sliding stall doors",
  ...
  },
  {
    ...
    alt: "Tan and brown barndominium with a covered entry, stone columns, an American flag and an attached garage",
  ...
  },
  {
    ...
    img: "images/gallery/g44.webp",
    alt: "Elegant post-frame home with a stone-columned covered porch and timber-frame entry",
    blurb: "A custom home with the open layouts post-frame construction makes possible.",
    tagline: "A custom home with more flexibility.",
  ...
  },
  {
    ...
    alt: "Covered back patio of a tan slab home with outdoor furniture and sliding glass doors",
